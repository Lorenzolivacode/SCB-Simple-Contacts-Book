  ...
  const languages = [
    {
      label: "IT",
      value: "it",
      SrcImg: "/flag-ico/IT-Flag.png",
      altImg: t("italianLabel"),
    },
    {
      label: "EN",
      value: "en",
      SrcImg: "/flag-ico/GB-Flag.png",
  ...
  return (
    <>
      ...
      <ul
        ...
        className="flex flex-cross-center gap-15px f-size-0d7"
      >
          ...
          return (
            <React.Fragment key={language.value}>
              ...
              {index + 1 !== languages.length && (
                <div
                  key={languages.length + 2}
                  className="w-2px h-25px radius-20px bg-secondary-light"
                />
              )}
            </React.Fragment>
          );
